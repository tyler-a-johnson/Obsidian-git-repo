...
We find the equation for the determinants, we can treat lengths as constants and solve that equation or when the determinant is equal to 0. When the determinant is zero, there is a singularity. 
